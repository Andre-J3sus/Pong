...
const val LIMIT_SCORE = 2 //Costante de ponto necessários para ganhar um jogo
 ...
 */
fun Canvas.writeWins(pn:Int, color:Int){
    drawText(2*WIDTH/7-4, SCORE_Y*2 + 4, "Player $pn Wins!", BLACK, 38)
    drawText(2*WIDTH/7, SCORE_Y*2, "Player $pn Wins!", color, 38)
}
